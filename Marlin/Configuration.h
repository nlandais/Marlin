...
#define STRING_CONFIG_H_AUTHOR "(Nic, Ender-3-Pro)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Nic's Ender-3 Pro 4.2.7 Printer"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -43, -9, -3.600 }
